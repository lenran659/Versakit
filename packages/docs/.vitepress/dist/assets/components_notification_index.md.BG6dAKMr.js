import { i as a, j as s } from './chunks/theme.BKnsVfWH.js'
import {
  d as V,
  o as p,
  a as f,
...
`,
  ...
  k = B(N, [['__scopeId', 'data-v-6a788921']]),
  G = `<template>\r
  <div>\r
...
`,
  ...
  x = B(w, [['__scopeId', 'data-v-4e985c50']]),
  C = `<template>\r
  <div>\r
    <VerButton type="info" @click="info">info</VerButton>\r
    <VerButton type="success" @click="success">success</VerButton>\r
...
`,
  ...
  A = B(F, [['__scopeId', 'data-v-84b48062']]),
  _ = `<template>\r
  <div>\r
...
`,
  ...
  j = { name: 'components/notification/index.md' },
  M = Object.assign(j, {
    setup(m) {
      return (d, t) => {
        const c = h('ClientOnly'),
          u = h('Tool')
        return (
          p(),
          f('div', null, [
